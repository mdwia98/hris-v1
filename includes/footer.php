...
?>
    ...
    <footer class="footer">
        ...
        <p>
            ...
            <a href="<?php echo BASE_URL; ?>help.php" style="color: var(--secondary-color); text-decoration: none;">Bantuan</a>
            <span class="divider">|</span>
            <a href="<?php echo BASE_URL; ?>privacy.php" style="color: var(--secondary-color); text-decoration: none;">Privasi</a>
        </p>
    </footer>
